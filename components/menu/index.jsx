...
const Menu = ({ children }) => {
    ...
    return (
        ...
        <div className="relative">
            ...
            {/* Menu */}
            <div className={`${openMenu ? 'translate-x-[0%]' : 'translate-x-[-100%]'} transition-transform duration-300 lg:translate-x-[-100%] w-full h-full absolute flex bg-[rgba(255,255,255,0.64)] z-[999]`}>
                ...
                <div className="flex flex-col justify-between items-center bg-[rgba(255,255,255,0.3)] relative overflow-y-scroll overflow-x-hidden" onClick={() => setOpenMenu(!openMenu)}>
                ...
                <div className='Grilla-nav sm:w-[95%] p-2'>
                    ...
                    <header className='rounded-xl flex justify-center items-center bg-[rgba(255,255,255,0.3)] relative'>
                        ...
                        <div className='lg:flex hidden absolute right-0'>
                            <Link href={'/'} className="button px-3 text-xl font-[inherit] font-extrabold text-[#000000b4]">Home</Link>
                    ...
                    <nav className="Contenedor-Menu-Vertical grid-cols-1">
                        ...
                        {/* Contenido */}
                        <div id='ScrollMenu' className="w-full rounded-xl bg-[rgb(255,255,255)] overflow-auto sm:overflow-y-auto bg-[rgba(255,255,255,0.3)]">
                            {children}
                        </div>
