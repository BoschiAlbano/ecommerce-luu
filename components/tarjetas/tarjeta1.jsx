                ...
                <div key={index} className="card-productos vibrar">
                    ...
                    <div className="card_box shadow-2xl">
                        ...
                        <div className='flex flex-col justify-center items-center'>
                            ...
                            <p className='font-[roboto] font-extrabold uppercase text-2xl text-[#000000b4] mt-4'>$600</p>

                            <h1 className='font-[roboto] font-extrabold uppercase text-xl text-[#000000b4] mt-2'>{item.descripcion}</h1>
