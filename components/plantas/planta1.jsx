...
const Planta1 = ({
    ...
    const iconStyle = {
        ...
        left: `${left}px`,
        animation: hover
            ? 'slay-1 3s cubic-bezier(0.52, 0, 0.58, 1) infinite'
            : 'none',
    ...
    return (
        <div className={`icon-1 `} style={iconStyle}>
            ...
            >
                <g
                    transform="translate(0.000000,1112.000000) scale(0.100000,-0.100000)"
                    stroke="none"
                >
                    <path
                        d="M3920 11086 c-23 -61 -72 -290 -105 -486 -19 -118 -47 -277 -61 -352
